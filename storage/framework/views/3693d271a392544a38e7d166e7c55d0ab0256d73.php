                    ...
                    <?php if($socialUrls): ?>
                     <?php for($j=$i;$j<=$socialUrls->max_val;$j++): ?>
                        <?php if($socialUrls->facebook != '' && !$socialUrls->facebook_is_featured && $socialUrls->fb_l==$j): ?>
                            ...
                            <a href="https://www.facebook.com/<?php echo e($socialUrls->facebook); ?>" target="_blank" class="social-tag facebook-icon"></a>
                        <?php endif; ?>
                        <?php if($socialUrls->messenger != '' && 11 ==$j): ?>

                            <a href="http://m.me/<?php echo e($socialUrls->messenger); ?>" target="_blank" class="social-tag messenger-icon"></a>
                        <?php endif; ?>

                        <?php if($socialUrls->twitter != '' && !$socialUrls->twitter_is_featured && $socialUrls->tw_l==$j): ?>
                            <a href="https://twitter.com/<?php echo e($socialUrls->twitter); ?>" target="_blank" class="social-tag twitter-link"></a>
                        <?php endif; ?>

                        <?php if($socialUrls->linkedin != '' && !$socialUrls->linkedin_is_featured && $socialUrls->ln_l==$j): ?>
                            <a href="https://www.linkedin.com/in/<?php echo e($socialUrls->linkedin); ?>" target="_blank" class="social-tag linkedin-icon"></a>
                        <?php endif; ?>

                        <?php if($socialUrls->instagram != '' && !$socialUrls->instagram_is_featured && $socialUrls->in_l==$j): ?>
                            <a href="https://www.instagram.com/<?php echo e($socialUrls->instagram); ?>" target="_blank" class="social-tag instgram-link"></a>
                        <?php endif; ?>

                        <?php if($socialUrls->youtube != '' && !$socialUrls->youtube_is_featured && $socialUrls->yu_l==$j): ?>
                            <a href="https://www.youtube.com/channel/<?php echo e($socialUrls->youtube); ?>" target="_blank" class="social-tag youtube-link"></a>
                        <?php endif; ?>

                        <?php if($socialUrls->behance != '' && !$socialUrls->behance_is_featured && $socialUrls->be_l==$j): ?>
                            <a href="https://www.behance.net/<?php echo e($socialUrls->behance); ?>" target="_blank" class="social-tag be-icon"></a>
                        <?php endif; ?>

                        <?php if($socialUrls->whatsapp != '' && !$socialUrls->whatsapp_is_featured && $socialUrls->wt_l==$j): ?>
                            <a href="https://wa.me/<?php echo e($socialUrls->whatsapp); ?>" target="_blank" class="social-tag whatsapp-link"></a>
                        <?php endif; ?>

                        <?php if($socialUrls->snapchat != '' && !$socialUrls->snapchat_is_featured && $socialUrls->fb_l==$j): ?>
                            <!-- <a href="<?php echo e($socialUrls->snapchat); ?>" target="_blank" class="social-tag snapchat-link"></a> -->
                        <?php endif; ?>

                        <?php if($socialUrls->skype != '' && !$socialUrls->skype_is_featured && $socialUrls->skp_l==$j): ?>
                            <a href="skype:<?php echo e($socialUrls->skype); ?>?chat" target="_blank" class="social-tag skype-link"></a>
                        <?php endif; ?>
                       <?php endfor; ?>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\brush-bio\resources\views/home.blade.php ENDPATH**/ ?>