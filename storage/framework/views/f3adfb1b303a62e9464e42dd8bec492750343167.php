    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="www.brush.bio/<?php echo e($user->slug); ?>" id="website" name="website" placeholder="yourwebsite.com">
        ...
        <!--<div class="col-md-6">
            <div class="form-group">
               <label for="website" class="col-form-label">Portfolio</label>
                <input type="text" class="form-control" value="<?php echo e($user->website); ?>" name="website" id="website" placeholder="yourwebsite.com">
                <span class="error_input website_error text-danger"></span>
            </div>
        </div>-->
        <div class="col-md-6">
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\XAMPP\htdocs\brush_bio\resources\views/user_vcard/ajax/edit.blade.php ENDPATH**/ ?>