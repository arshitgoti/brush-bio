<form method="post" action="<?php echo e(route('user.social.url.update', $user_social_url->id)); ?>" id="frmStoreUserSocialUrls" class="frmStore">
    ...
    <div class="modal-body" id="social-main-modal">
        ...
        <?php elseif($user_social_url->msng_l==$i): ?>
        <li>
            <div class="row">
                <div class="form-group col-12">
                    <div class="input-group mb-3">
                        ...
                        <input type="hidden" id="liposition" name="msng_l" value="<?php echo e($i); ?>">
                        <input type="text" value="<?php echo e($user_social_url->messenger); ?>" class="form-control" name="messenger" aria-label="user_messenger_url" aria-describedby="user_messenger_url" placeholder="enter username only">
        ...
        <div class="row">
            <div class="form-group col-12">
                <div class="input-group mb-3" id="custom-flex-design-hide">
                    ...
                    <input type="text" value="<?php echo e($user_social_url->whatsapp); ?>" class="form-control" name="whatsapp" aria-label="user_whatsapp_url" aria-describedby="user_whatsapp_url" placeholder="enter whatsapp number only" id="whatsapp_number" style="margin-left: 78px;!important;">
...
<?php /**PATH D:\XAMPP\htdocs\brush-bio\resources\views/user_social_url/ajax/edit.blade.php ENDPATH**/ ?>