<form method="post" action="<?php echo e(route('user.exhibition.store')); ?>" id="frmStoreUserExhibition" class="frmStore">
    <?php echo csrf_field(); ?>
...
<?php /**PATH /home/k95ehvyw2f5n/public_html/resources/views/user_exhibition/ajax/create.blade.php ENDPATH**/ ?>