    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="www.brush.bio/<?php echo e($user->slug); ?>" id="website" placeholder="yourwebsite.com">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/k95ehvyw2f5n/public_html/resources/views/user_vcard/ajax/edit.blade.php ENDPATH**/ ?>