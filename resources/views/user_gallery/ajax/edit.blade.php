<form method="post" action="{{ route('user.gallery.update', $user_gallery->id) }}" id="frmUpdateUserGallery" class="frmStore">
    @csrf
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" value="{{ $user_gallery->name }}" id="name" required>
            ...
            {{-- <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="link" value="{{ $user_gallery->link }}" id="link">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea name="address" class="form-control" id="address" rows="3">{{ $user_gallery->address }}</textarea>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="postal_code" value="{{ $user_gallery->postal_code }}" id="postal_code" required>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="city" value="{{ $user_gallery->city }}" id="city" required>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <option {{$user_gallery->country== $country ? 'selected' : ''}} value="{{$country}}">{{$country}}</option>
                    @endforeach
                </select>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" name="email" value="{{ $user_gallery->email }}" id="email" required>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="phone" value="{{ $user_gallery->phone }}" id="phone">
                    <input type="hidden" name="phone_code" id="phone_code" value="{{ $user_gallery->phone }}">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="website" value="{{ $user_gallery->website }}" id="website" placeholder="yourwebsite.com">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="instagram" value="{{ $user_gallery->instagram }}" id="instagram" placeholder="enter username only">
