...
<form method="post" action="{{ route('user.portfolio.url.store') }}" id="frmStoreUserWebsite" class="frmStore">
    @csrf
    ...
    <div class="modal-body" >
        ...
        <div class="url_container"  id="linksort">
          <ul id="sortable" class="url_container1 sortable" style="list-style-type:none; z-index: 999999;">
           <li>
            <input type="hidden" name="portfolio_url[position][]" id="liposition">
            <div class="card mb-3">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
