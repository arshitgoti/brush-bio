<form method="post" action="{{ route('user.bio.store') }}" id="frmStoreUserBio" class="frmStore">
    @csrf
    ...
    <div class="modal-body">
        <div class="form-group">
            ...
            <textarea name="bio_content" id="bio_content" class="form-control" rows="5" placeholder="Tell us more about yourself…"></textarea>
